...
public class SecurityClient implements UserDetails {
    ...
    public SecurityClient(String username, String password, List<SimpleGrantedAuthority> authorities, boolean isActive) {
    ...
    public static UserDetails fromUser(ClientEntity client){
